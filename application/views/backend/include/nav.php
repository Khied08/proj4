<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
    <a class="nav-link" href="<?= base_url('index.php/dashboard/view-officials') ?>">
        ...
        <span >Barangay Officials</span>
            ...
            <li class="nav-item active">
    <a class="nav-link" href="<?= base_url('index.php/dashboard/view-blotter') ?>" >
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= base_url();?>assets/backend/img/undraw_profile_1.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= base_url();?>assets/backend/img/undraw_profile_2.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= base_url();?>assets/backend/img/undraw_profile_3.svg"
                                            alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                               ...
                               <a href = "<?php echo base_url('index.php/logout');?>"class="btn btn-primary btn-user btn-block"> Logout </a>
...
.nav-item:hover .nav-link i.fas {
  color: #1a73e8; /* Change the text and icon color to #1a73e8 on hover */
}
</style>
